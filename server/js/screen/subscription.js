window.subscription = {
  ...
  dollarSvg: `<svg width="27" height="27" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_28_4)">
  <path d="M401.16 800C427.988 800 449.768 779.511 449.768 754.201C449.768 728.926 449.768 708.436 449.768 708.436C582.477 696.279 670.328 626.183 670.328 512.153V510.288C670.328 394.394 595.558 341.129 446.962 306.56V198.148C468.355 203.376 490.509 210.784 512.16 220.393C547.004 235.839 589.348 226.158 610.504 191.572C631.676 157.006 620.239 108.452 581.016 90.8435C541.96 73.3297 499.096 61.2644 451.616 56.0741V28.0269C451.616 12.5647 429.869 0 403.025 0C376.18 0 354.417 11.9363 354.417 26.6036C354.417 41.3287 354.417 53.2446 354.417 53.2446C211.399 63.5368 131.031 140.172 131.031 250.452V252.337C131.031 368.215 207.665 419.649 358.146 454.197V566.362C322.045 560.544 286.702 548.553 250.73 530.187C212.411 510.638 165.467 517.551 142.243 551.875C119.003 586.183 128.388 634.923 167.02 653.877C223.776 681.758 287.921 699.972 352.531 706.589V753.311C352.552 779.086 374.315 800 401.16 800ZM446.001 469.164C494.629 483.168 508.631 497.211 508.631 522.429V524.314C508.631 551.417 489.011 567.286 446.001 571.981V469.164ZM295.516 238.294V236.43C295.516 212.136 313.288 193.437 359.07 189.707V290.656C308.618 276.631 295.516 262.588 295.516 238.294Z" fill="white"/>
  </g>
  <defs>
  ...
  load: function () {
    ...
    subscription.packages.forEach((pack) => {
      packages_html += `<div class='package'>
    ...
    switch (event.keyCode) {
      ...
      case tvKey.KEY_ENTER:
        ...
        if (session.storage.customer) {
          if (
            session.storage.customer.active_subscriptions &&
            session.storage.customer.active_subscriptions.length > 0
          ) {
